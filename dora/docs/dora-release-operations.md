...
| Optional capability-documentation control | Keep a legacy adapter unchanged, or adopt it only through a consumer-owned plan; run Doctor, the inventory/documentation checks, and consumer-specific validation. |
